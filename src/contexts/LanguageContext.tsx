...
const translations = {
  en: {
    ...
    "home.features.communityDesc": "Join a network of over 3,000 students from 84 universities",
    ...
    "home.whyJoin.networkDesc": "Connect with students from 84 universities across Europe",
  ...
  sl: {
    ...
    "home.features.communityDesc": "Pridružite se mreži več kot 3.000 študentov z 84 univerz",
    ...
    "home.whyJoin.networkDesc": "Povežite se s študenti z 84 univerz po Evropi",
